package cn.fcw.tran.modules.generator.utils;
import cn.fcw.tran.common.exception.CustomException;
import cn.fcw.tran.common.utils.DateUtils;
import cn.fcw.tran.modules.generator.entity.ColumnEntity;
import cn.fcw.tran.modules.generator.entity.TableEntity;
...
public class GenUtils {
    ...
    public static void generatorCode(Map<String, String> table, List<Map<String, String>> columns, ZipOutputStream zip) {
        ...
        mainPath = StringUtils.isBlank(mainPath) ? "cn.fcw.tran" : mainPath;
